...
import { Mail, Lock, ArrowRight, Loader2, AlertCircle, Eye, EyeOff, X, CheckCircle } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="space-y-2 text-center md:text-left">
        ...
        <p className="text-slate-400 text-sm">
          Enter your details to access your travel command center
        </p>
      </div>
